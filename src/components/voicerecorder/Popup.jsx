...
export const ApprovalPopup = ({ setOpenPopup, queryString, fetchLinks }) => {
  return (
    <>
          ...
          >
            ...
            <div className="p-6 text-center w-[300px]">
              ...
              <button
                data-modal-hide="popup-modal"
                type="button"
                className="text-white bg-[#E0C5FA] hover:bg-[#cea9f1] font-bold rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
                onClick={fetchLinks}
              >
                Approved
              </button>
...
export const LinksPopup = ({
  ...
  return (
    <>
      <div className="md:inset-0 absolute top-0 !right-[20px] flex items-center">
        <div className="w-full max-w-[300px] h-[325px] overflow-y-auto ml-auto">
          <div className="pt-20 pb-10 px-5 relative bg-[#E6E8FA] rounded-lg shadow-lg dark:bg-gray-700">
            <button
              type="button"
              className="absolute top-3 right-2.5 text-[#E00000] bg-transparent rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center close-icon"
              data-modal-hide="popup-modal"
              onClick={() => setResponseLinksPopup(false)}
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
            ...
            <div className="text-left">
              ...
              <ul className="mb-2 last:mb-0">
                {responseLinks?.map((link, index) => (
                  <li
                    key={index}
                    className="text-gray-700 break-words text-left mb-2 last:mb-0"
