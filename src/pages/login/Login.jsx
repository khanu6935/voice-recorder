  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string()
        ...
        .min(3, "Password should be more than 4"),
    }),
      ...
      <div className="lg:w-[40%] w-full  bg-[#CEF0F9] flex justify-center flex-col px-8 items-center h-full ">
        ...
        <div className="bg-white lg:w-[80%] md:w-[70%] w-full flex flex-col rounded-lg shadow-lg">
          ...
          >
            ...
            <Google />
            <div className="flex font-[YACgEQNAr7w O] text-[#9CABBA] text-[10px] justify-center gap-2 pt-3">
              <p>Do you have an account?</p>
              <span className="font-[YACgEQNAr7w O] text-color text-[10px] font-bold">
